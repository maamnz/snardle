// Curated standard 5-letter answer words (subset for core gameplay) + common guess words
const ANSWER_WORDS = [
  "ABACK", "ABASE", "ABATE", "ABBEY", "ABIDE", "ABOUT", "ABOVE", "ABYSS", "ACRID", "ACTOR",
  "ACUTE", "ADAPT", "ADMIT", "ADOBE", "ADOPT", "ADORE", "ADULT", "AFTER", "AGAIN", "AGAPE",
  "AGATE", "AGENT", "AGILE", "AGING", "AGLOW", "AGONY", "AGREE", "AHEAD", "AIDER", "AISLE",
  "ALARM", "ALBUM", "ALERT", "ALIEN", "ALIGN", "ALIKE", "ALIVE", "ALLAY", "ALLEY", "ALLOT",
  "ALLOW", "ALLOY", "ALONE", "ALONG", "ALOOF", "ALOUD", "ALPHA", "ALTAR", "ALTER", "AMASS",
  "AMBER", "AMISS", "AMPLE", "ANGEL", "ANGER", "ANGLE", "ANGRY", "ANKLE", "ANTIC", "ANVIL",
  "APART", "APHID", "APPLY", "APRON", "APTLY", "ARBOR", "ARDOR", "ARENA", "ARGUE", "ARISE",
  ...
  "AXIAL", "AXIOM", "BACON", "BADGE", "BADLY", "BAGEL", "BAKER", "BALMY", "BANAL", "BANJO",
  "BARGE", "BASIC", "BASIN", "BASTE", "BATCH", "BATON", "BATTY", "BEACH", "BEAST", "BEGAN",
  "BEGIN", "BEING", "BELIE", "BELLY", "BELOW", "BENCH", "BERET", "BERTH", "BESET", "BETEL",
  "BEVEL", "BINGE", "BIOME", "BIRCH", "BIRTH", "BISON", "BITTY", "BLACK", "BLADE", "BLAME",
  ...
  "BOSSY", "BOTCH", "BOUGH", "BOULT", "BOUND", "BOWEL", "BOXER", "BRACE", "BRAID", "BRAIN",
  ...
  "BUYER", "BYLAW", "CABIN", "CABLE", "CACAO", "CACHE", "CACTI", "CADDY", "CADET", "CAGEY",
  ...
  "CREPE", "CREPT", "CRESS", "CREST", "CRICK", "CRIER", "CRIME", "CRIMP", "CRISP", "CROAK",
  "CROCK", "CRONY", "CROOK", "CROSS", "CROUP", "CROWD", "CROWN", "CRUDE", "CRUEL", "CRUMB",
  "CRUMP", "CRUSH", "CRUST", "CRYPT", "CUBIC", "CUMIN", "CURIO", "CURLY", "CURRY", "CURSE",
  "CURVE", "CURVY", "CUTIE", "CYBER", "CYNIC", "DADDY", "DAILY", "DAIRY", "DAISY", "DALLY",
  ...
  "FINAL", "FINCH", "FINER", "FIRST", "FISHY", "FIXER", "FIZZY", "FJORD", "FLAIL", "FLAIR",
  ...
  "GENRE", "GHOST", "GHOUL", "GIANT", "GIDDY", "GIRTH", "GIVEN", "GIVER", "GLADE", "GLAND",
  ...
  "HUMUS", "HUNCH", "HUNKY", "HURRY", "HUSKY", "HUTCH", "HYDRA", "HYENA", "HYPER", "ICING",
  ...
  "JOLLY", "JOUST", "JUDGE", "JUICE", "JUICY", "JUMBO", "JUMPY", "JUNTA", "JUROR", "KAPPA",
  ...
  "LURCH", "LURID", "LUSTY", "LYING", "LYMPH", "LYRIC", "MACAW", "MACHO", "MACRO", "MADAM",
  ...
  "MUCKY", "MUCUS", "MUDDY", "MULCH", "MUMMY", "MURAL", "MURKY", "MUSHY", "MUSIC", "MUSKY",
  ...
  "PRAYE", "PREEN", "PRESS", "PRICE", "PRICK", "PRIDE", "PRIED", "PRIME", "PRIMO", "PRINT",
  ...
  "SHARP", "SHAVE", "SHAWL", "SHEAF", "SHEAR", "SHED", "SHEEN", "SHEEP", "SHEER", "SHEET",
  ...
  "SKUNK", "SLACK", "SLAIN", "SLANG", "SLANT", "SLASH", "SLATE", "SLEEK", "SLEEP", "SLEET",
  ...
  "SPOON", "SPORE", "SPORT", "SPOUT", "SPRAY", "SPREE", "SPRIG", "SPURT", "SQUAD", "SQUAT",
  ...
  "TUNIC", "TURBO", "TUTOR", "TWANG", "TWEAR", "TWEED", "TWEET", "TWICE", "TWINE", "TWIRL",
  "TWIST", "TWIXT", "TYING", "UDDER", "ULCER", "ULTRA", "UMBRA", "UNCLE", "UNCUT", "UNDER",
  "UNDID", "UNDUE", "UNFED", "UNFIT", "UNIFY", "UNION", "UNITE", "UNITY", "UNLIT", "UNMET",
  "UNSET", "UNTIE", "UNTIL", "UNWED", "UNZIP", "UPBEAT", "UPEND", "UPPER", "UPSET", "URBAN",
  "URINE", "USAGE", "USER", "USHER", "USING", "USUAL", "USURP", "UTILE", "UTTER", "VAGUE",
  ...
  "VOWEL", "VOUCH", "WACKY", "WAFER", "WAGER", "WAGON", "WAIST", "WAIVE", "WALTZ", "WARTY",
...
// Set of valid guess words for quick O(1) lookup
const VALID_GUESS_SET = new Set(ANSWER_WORDS);
